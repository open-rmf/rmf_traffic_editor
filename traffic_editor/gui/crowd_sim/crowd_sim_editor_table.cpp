      ...
      _project(input_project)
{
    ...
    _enable_crowd_sim_name_item = new QTableWidgetItem(QString::fromStdString("enable_crowd_sim"));
    ...
    _update_time_step_name_item = new QTableWidgetItem(QString::fromStdString("update_time_step"));
    setItem(1, 0, _update_time_step_name_item);
    _update_time_step_value_item = new QLineEdit(QString::number(_impl->get_update_time_step()), this);
    ...
    for (size_t i = 0; i < _required_components.size(); ++i) {
        ...
        QTableWidgetItem* name_item = new QTableWidgetItem (QString::fromStdString(_required_components[i]) );
...
{   
    ...
    _enable_crowd_sim_checkbox->setChecked( _impl->get_enable_crowd_sim() );
    _update_time_step_value_item->setText(QString::number(_impl->get_update_time_step() ));
