...
//===================================================
std::shared_ptr<ModelTypeTab> ModelTypeTab::init_and_make(CrowdSimImplPtr crowd_sim_impl)
{
...
void ModelTypeTab::list_item_in_cache()
{
    ...
    for (auto i = 0; i < cache_count; i++) {
        ...
        setItem(i, 0, 
            new QTableWidgetItem(QString::fromStdString(current_model_type.get_name() )));
        setItem(i, 1, 
            new QTableWidgetItem(QString::fromStdString(current_model_type.get_animation() )));
        setItem(i, 2, 
            new QTableWidgetItem(QString::number(current_model_type.get_animation_speed() )));
        setItem(i, 3, 
            new QTableWidgetItem(QString::fromStdString(current_model_type.get_gazebo_conf().filename )));
        setItem(i, 4, 
            new QTableWidgetItem(QString::number(current_model_type.get_gazebo_conf().initial_pose[0] )));
        setItem(i, 5, 
            new QTableWidgetItem(QString::number(current_model_type.get_gazebo_conf().initial_pose[1] )));
        setItem(i, 6, 
            new QTableWidgetItem(QString::number(current_model_type.get_gazebo_conf().initial_pose[2] )));
        setItem(i, 7, 
            new QTableWidgetItem(QString::number(current_model_type.get_gazebo_conf().initial_pose[3] )));
        setItem(i, 8, 
            new QTableWidgetItem(QString::number(current_model_type.get_gazebo_conf().initial_pose[4] )));
        setItem(i, 9, 
            new QTableWidgetItem(QString::number(current_model_type.get_gazebo_conf().initial_pose[5] )));
        setItem(i, 10, 
            new QTableWidgetItem(QString::fromStdString(current_model_type.get_ign_conf().filename )));
        setItem(i, 11, 
            new QTableWidgetItem(QString::number(current_model_type.get_ign_conf().initial_pose[0] )));
        setItem(i, 12, 
            new QTableWidgetItem(QString::number(current_model_type.get_ign_conf().initial_pose[1] )));
        setItem(i, 13, 
            new QTableWidgetItem(QString::number(current_model_type.get_ign_conf().initial_pose[2] )));
        setItem(i, 14, 
            new QTableWidgetItem(QString::number(current_model_type.get_ign_conf().initial_pose[3] )));
        setItem(i, 15, 
            new QTableWidgetItem(QString::number(current_model_type.get_ign_conf().initial_pose[4] )));
        setItem(i, 16, 
            new QTableWidgetItem(QString::number(current_model_type.get_ign_conf().initial_pose[5] )));
    }
}
