...
Description:
    ...
    * navmesh.nav: defines the walkable area for each agents
    * behavior.xml: defines the finite state machine for the gobal path plan
    * scene.xml: defines the properties for each agent for
    ...
    * "building_yaml_parse.py" is depend on "building_map" package, which
    parses the vertices coordinates and collects the human_goals

You can check Menge working details in
https://github.com/FloodShao/crowd_simulation/blob/master/README.md
"""
