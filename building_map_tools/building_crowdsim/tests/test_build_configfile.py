...
def test_scene_from_yaml(map_file):
...
def test_behavior_from_yaml(map_file):
    yaml_parse = BuildingYamlParse(map_file)
    crowd_sim_yaml = yaml_parse.crowd_sim_config
...
def test_plugin_from_yaml(map_file):
...
if __name__ == '__main__':
    ...
    print("=========================")
    try:
        test_behavior_from_yaml(map_file)
    except KeyboardInterrupt:
        pass
    ...
    print("=========================")
    try:
        test_plugin_from_yaml(map_file)
    except KeyboardInterrupt:
        pass
